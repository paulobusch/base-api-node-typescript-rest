...
import { ViewModel } from "./action-view-model.interface";
...
export abstract class Query<TResult extends ViewModel<TResult> | QueryPaginated<TResult>> implements IAction<TResult> {
